...
if (isset($_SESSION['studentID']) && !empty($_SESSION['studentID'])) {
    ...
    STUDENT HOME PAGE
    <br><br>
    <input type="button" value="NOTIFICATIONS" id="nf">
    <script>
    ...
    <br><br>
    <input type="button" value="BOOKS" id="bk">
    <script>
    ...
    <br><br>
    <input type="button" value="HISTORY" id="h">
    <script>
    ...
    <br><br>
    <input type="button" value="BOOKMARK LIST" id="bM">
    <script>
    ...
    <br><br>
    <input type="button" value="REQUEST LIST" id="rl">
    <script>
    ...
    <br><br>
    <input type="button" value="DONATE HISTORY" id="dh">
    <script>
    ...
    <br><br>
    <input type="button" value="DONATE BOOKS" id="db">
    <script>
